...
class TOCHATBE_Admin_Init {
	...
	/**
	 * Redirect to Just WhatsApp Icon tab.
	 *
	 * @return void
	 */
	public function redirect_to_just_whatsapp_icon_tab() {
		if ( 'yes' === tochatbe_just_whatsapp_icon_option( 'status' ) ) {
			if ( isset( $_GET['post_type'] ) && 'tochatbe_agent' == $_GET['post_type'] ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
	...
	/**
	 * Sanitize type and chat settings.
	 *
	 * @param array $input Input data.
	 * @return array
	 */
	...
	/**
	 * Sanitize Just WhatsApp Icon settings.
	 *
	 * @param array $input Input data.
	 * @return array
	 */
	...
	/**
	 * Sanitize Facebook Analytics settings.
	 *
	 * @param array $input Input data.
	 * @return array
	 */
	...
	/**
	 * Sanitize WooCommerce order button settings.
	 *
	 * @param array $input Input data.
	 * @return array
	 */
	...
	/**
	 * Redirect to add agent if no agent added.
	 *
	 * @return void
	 */
	public function redirect_to_add_agent_if_no_agent_added() {
		...
		if ( 'edit.php' !== $pagenow || ! isset( $_GET['post_type'] ) || 'tochatbe_agent' !== $_GET['post_type'] ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
			return;
		}
